        ...
        <div className="find-booking-page">
            ...
            {bookingDetails && (
                <div className="booking-details">
                    ...
                    <h3>Villa Details</h3>
                    <div>
                        <p> Villa Type: {bookingDetails.villa.villaType}</p>
                        <p> Villa Price: ${bookingDetails.villa.villaPrice}</p>
                        <p> Villa Description: {bookingDetails.villa.villaDescription}</p>
                        <img src={bookingDetails.villa.villaPhotoUrl} alt="" sizes="" srcSet="" />
                    </div>
                    <button
