...
import com.villavista.VillaVista.service.interfac.IUserService;
import com.villavista.VillaVista.utils.JWTUtils;
...
public class UserService implements IUserService {
    ...
    public Response getUserBookingHistory(String userId) {
        ...
        try {
            ...
            UserDTO userDTO = Utils.mapUserEntityToUserDTOPlusUserBookingsAndVilla(user);
            response.setStatusCode(200);
            response.setMessage("successful");
            response.setUser(userDTO);
